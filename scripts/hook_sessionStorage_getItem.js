...
if (!window.__ADB_OBSERVER__?.isInstalled?.("hook_sessionStorage_getItem")) {
// ==UserScript==
...
(function () {
    ...
    function initHook() {
        if (adbInitialized || window.__ADB_OBSERVER__?.isInstalled?.("hook_sessionStorage_getItem")) return;
