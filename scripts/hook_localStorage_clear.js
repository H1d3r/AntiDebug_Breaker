...
if (!window.__ADB_OBSERVER__?.isInstalled?.("hook_localStorage_clear")) {
// ==UserScript==
...
(function () {
    ...
    function initHook() {
        if (adbInitialized || window.__ADB_OBSERVER__?.isInstalled?.("hook_localStorage_clear")) return;
        ...
        localStorage.clear = function () {
            if (flag === "0") {
                console.log(adbLogText("log_local_storage_clear", "Captured removal of all localStorage entries"));
